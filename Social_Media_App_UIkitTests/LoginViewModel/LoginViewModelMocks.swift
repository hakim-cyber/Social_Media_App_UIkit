...
@MainActor
final class LoginViewModelMockAuthService: AuthServicing {
    ...
    func signUp(email: String, password: String) async throws -> User {
        throw LoginViewModelTestError("Not used in tests")
    }
...
@MainActor
final class LoginViewModelMockSocialAuthService: SocialAuthServicing {
...
struct LoginViewModelTestError: LocalizedError {
    let message: String
